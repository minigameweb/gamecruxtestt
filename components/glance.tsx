                ...
                <div className='flex flex-col w-full gap-6 sm:gap-8 md:gap-10 items-center lg:items-end mt-10 sm:mt-16 md:mt-20 lg:mt-28'>
                    ...
                    >
                        <div className='p-4 sm:p-5'>
                            <h3>games</h3>
                            <h1 className='plain-heading special-font font-zentry text-3xl sm:text-5xl md:text-7xl lg:text-9xl hover-text'>4<b>+</b></h1>
                        </div>
                    ...
                    <div
                        ...
                        onMouseLeave={() => setIsHovering(false)}
                    >
                        <h1 className='plain-heading font-zentry text-black text-6xl sm:text-8xl md:text-[12rem] lg:text-[16rem] leading-none hover-text'>1<b>0</b>+</h1>
                    ...
                    >
                        <div className='p-2 px-4 sm:px-5'>
                            ...
                            <h1  className='plain-heading special-font font-zentry text-black text-5xl sm:text-6xl md:text-7xl lg:text-[8rem] leading-none text-start hover-text'>100<b></b><b>+</b></h1>
                        </div>
                ...
                <div className='flex flex-col w-full gap-6 sm:gap-8 md:gap-10 items-center lg:items-start'>
                    ...
                    >
                        <div className='p-2'>
                            ...
                            <h1 id='text-3d' className='plain-heading special-font font-zentry text-black text-6xl sm:text-8xl md:text-[12rem] lg:text-[14rem] leading-none text-center hover-text'>100<b>0</b>+</h1>
                        </div>
                    ...
                    <div
                        ...
                        onMouseLeave={() => setIsHovering(false)}
                    >
                        <h1 className='plain-heading font-zentry text-white text-4xl sm:text-5xl md:text-[4.5rem] max-w-sm leading-none text-start hover-text'>W<b>o</b>rld-Class G<b>a</b>mes</h1>
                    ...
                    >
                        <div className='p-2'>
                            ...
                            <h1 className='plain-heading special-font font-zentry plain-heading text-black text-6xl sm:text-8xl md:text-[16rem] lg:text-[18rem] px-4 leading-none sm:leading-[10rem] md:leading-[16rem] lg:leading-[20rem] text-start hover-text'>10<b>0</b>+</h1>
                        </div>
                    </div>
                </div>
            </div>
